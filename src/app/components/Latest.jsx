...
export default function LatestProducts() {
  ...
  sx={{
    width: "100%",
    height: { xs: 140, sm: 180, md: 200, lg: 220 }, // responsive fixed heights
    objectFit: "contain", // show full image without crop
    backgroundColor: "#f9f9f9", // neutral bg behind transparent/odd ratio images
    p: 1, // small padding so image doesn't stick to edges
